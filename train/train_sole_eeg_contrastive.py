...
# import dataset without fmri
from dataset_sole_eeg import BrainStimuliDatasetEEG, build_dataloaders
from eeg_encoder import EEGEncoderWithLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_path", type=str, default="configs/eeg_sole.yaml",
    ...
    model = EEGEncoderWithLoss(**config.model_kwargs.eeg_kwargs).to(accelerator.device).to(weight_dtype)
    
    # Build dataloader without fmri
    dataset = BrainStimuliDatasetEEG(**config.dataloader_kwargs.dataset)
